...
export default function HamburgerMenu({ isOpen, onClose }: HamburgerMenuProps) {
  ...
  useEffect(() => {
    if (isOpen && selectedRoomRef.current && room_id) {
    ...
    <div className="fixed inset-0 z-50 lg:hidden">
      ...
      <div className="absolute inset-0 bg-gray-800 flex flex-col overflow-y-auto">
        ...
        <div className="flex justify-between items-center p-4 border-b border-gray-700">
          ...
          <button onClick={onClose} className="text-white hover:text-gray-400 transition-colors">
            <svg
        ...
        <div className="p-4 border-b border-gray-700">
          ...
          <div className="relative">
            ...
            {activeDropdown === 'create' && (
              <div className="mt-3 bg-gray-800/95 backdrop-blur-sm border border-gray-600/50 rounded-2xl p-5 shadow-2xl animate-in slide-in-from-top-2 duration-200">
