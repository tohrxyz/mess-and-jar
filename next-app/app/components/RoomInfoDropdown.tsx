...
export default function RoomInfoDropdown({ room }: RoomInfoDropdownProps) {
    ...
    return (
        <div className="relative" ref={dropdownRef}>
            ...
            {/* Dropdown overlay */}
            {isOpen && (
                <div className="absolute top-8 -left-25 w-64 sm:left-0 z-50 bg-gray-800 border border-gray-600 rounded-lg shadow-xl  sm:w-auto sm:min-w-[280px] max-w-[320px] p-4">
