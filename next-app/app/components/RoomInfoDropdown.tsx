      ...
      <div className="space-y-4">
        ...
        <div className="space-y-1">
          ...
          <div className="flex items-center gap-2">
            <div className="flex-1 text-sm text-gray-100 bg-gray-700 p-2 rounded font-mono break-all">{room.id}</div>
            <button
        ...
        <div className="space-y-1">
          ...
          <div className="flex items-center gap-2">
            <div className="flex-1 text-sm text-gray-100 bg-gray-700 p-2 rounded break-words">{room.name}</div>
            <button
