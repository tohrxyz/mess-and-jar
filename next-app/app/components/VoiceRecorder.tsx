          ...
          <div className="flex items-center gap-3 w-full justify-between recording-container">
            ...
            <div className="flex items-center justify-center">
              <svg
                ...
                viewBox="0 0 24 24"
                className="size-5 fill-white/90 hover:fill-white transition-colors"
              >
              ...
              >
                ...
                >
                  <path
                    ...
                    d="M6 7.5h12M9.75 7.5v-1.5a1.5 1.5 0 0 1 1.5-1.5h1.5a1.5 1.5 0 0 1 1.5 1.5v1.5m-7.5 0l.867 12.142A2.25 2.25 0 0 0 9.867 22.5h4.266a2.25 2.25 0 0 0 2.25-2.358L17.25 7.5"
                  />
                </svg>
              </span>
            </div>
